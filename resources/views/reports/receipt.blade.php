<div id="invoice-POS">
        ...
        <div class="mid">
            <div class="info">
                <h2>Contact Us</h2>
                <p>
                    Address: sdfghjksdfghjk
                    Email: laraavelpos@gmail.com
                    Phone: 09876543
                </p>
            </div>
        </div>
            ...
            <div id="table">
                <table>
                    ...
                    <tr class="tabletitle"> 
                        ...
                        <td class="Payment"><p class="itemtext">{{number_format($receipt->amount, 2)}}</p></td>
                    </tr>
                    <tr class="tabletitle"> 
                        <td></td>
                        <td></td>
                        ...
                        <td class="Payment">{{number_format($order_receipt->sum('amount'), 2)}}
                            <h2></h2>
                        </td>
                    </tr>
                </table>
                <div class="legalcopy">
                    <p class="legal">
                        <strong>** Thank you for visiting **<br>The good which are subject to tax, prices includes tax</strong>
                    </p>
                </div>
